                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/210.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/215.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/209.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/197.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
                                                        <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-4312</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/178.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/22.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/1.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1324</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/24.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/71.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/41.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 2635</a>
                                                        <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-1523</span>
                                                    </td>
                                                    <td>
                                                        <span class="text-gray-800 fw-bold d-block fs-6 ps-0 text-end">x1</span>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/63.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/59.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/10.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/96.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{asset('backend/assets/media/stock/ecommerce/13.png')}}" class="w-50px ms-n1" alt="" />
                                                    </td>
                                                    <td class="ps-0">
                                                        <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
                    ...
                    <div class="card h-md-100" dir="ltr">
                        ...
                        <div class="card-body d-flex flex-column flex-center">
                            ...
                            <div class="text-center mb-1">
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-primary me-2" href="{{asset('backend/apps/ecommerce/sales/listing.html')}}">View App</a>
                                <!--end::Link-->
                                <!--begin::Link-->
                                <a class="btn btn-sm btn-light" href="{{asset('backend/apps/ecommerce/catalog/add-product.html')}}">New Product</a>
                                <!--end::Link-->
                            </div>
                            <!--end::Links-->
                        </div>
                        ...
                        <div class="card-body pt-2">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#XGY-346</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#YHD-047</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#SRR-678</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#PXF-534</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#XGD-249</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#SKP-035</a>
                                        </td>
                                        <td class="text-end">2 day ago</td>
                                        <td class="text-end">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary">#SKP-567</a>
                                        </td>
                                        <td class="text-end">7 min ago</td>
                                        <td class="text-end">
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card card-flush h-xl-100">
                        ...
                        <div class="card-header pt-7">
                            ...
                            <!--begin::Toolbar-->
                            <div class="card-toolbar">
                                <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="btn btn-sm btn-light">Order Details</a>
                            </div>
                            <!--end::Toolbar-->
                        </div>
                        <!--end::Header-->
                            ...
                            <div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{asset('backend/assets/media/stock/ecommerce/210.png')}}" class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Wrapper-->
                                        <!--begin::Action-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        ...
                                        <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fw-bold">Jason Bourne</a></span>
                                        <!--end::Name-->
                                        <!--begin::Label-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{asset('backend/assets/media/stock/ecommerce/209.png')}}" class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Wrapper-->
                                        <!--begin::Action-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Name-->
                                        <span class="text-gray-400 fw-bold">To:
                                        <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fw-bold">Marie Durant</a></span>
                                        <!--end::Name-->
                                        <!--begin::Label-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{asset('backend/assets/media/stock/ecommerce/214.png')}}" class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
                                            <!--end::Title-->
                                        </div>
                                        <!--end::Wrapper-->
                                        <!--begin::Action-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Name-->
                                        <span class="text-gray-400 fw-bold">To:
                                        <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fw-bold">Dan Wilson</a></span>
                                        <!--end::Name-->
                                        <!--begin::Label-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{asset('backend/assets/media/stock/ecommerce/211.png')}}" class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
                                            <!--end::Title-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Name-->
                                        <span class="text-gray-400 fw-bold">To:
                                        <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fw-bold">Lebron Wayde</a></span>
                                        <!--end::Name-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light-success">Delivered</span>
                                        <!--end::Label-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{asset('backend/assets/media/stock/ecommerce/215.png')}}" class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
                                            <!--end::Title-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Name-->
                                        <span class="text-gray-400 fw-bold">To:
                                        <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fw-bold">Ana Simmons</a></span>
                                        <!--end::Name-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light-primary">Shipping</span>
                                        <!--end::Label-->
                                ...
                                <div class="border border-dashed border-gray-300 rounded px-7 py-3">
                                    ...
                                    <div class="d-flex flex-stack mb-3">
                                        ...
                                        <div class="me-3">
                                            <!--begin::Icon-->
                                            <img src="{{asset('backend/assets/media/stock/ecommerce/192.png')}}" class="w-50px ms-n1 me-1" alt="" />
                                            <!--end::Icon-->
                                            <!--begin::Title-->
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
                                            <!--end::Title-->
                                    ...
                                    <div class="d-flex flex-stack">
                                        <!--begin::Name-->
                                        <span class="text-gray-400 fw-bold">To:
                                        <a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fw-bold">Kevin Leonard</a></span>
                                        <!--end::Name-->
                                        <!--begin::Label-->
                                        <span class="badge badge-light-danger">Confirmed</span>
                                        <!--end::Label-->
                        ...
                        <div class="card-header pt-7">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-4">
                                    ...
                                    <!--end::Status-->
                                    <!--begin::Search-->
                                    <a href="{{asset('backend/apps/ecommerce/catalog/products.html')}}" class="btn btn-light btn-sm">View Stock</a>
                                    <!--end::Search-->
                                </div>
                                <!--begin::Filters-->
                            </div>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                                ...
                                <tbody class="fw-bold text-gray-600">
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">Macbook Air M1</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">Surface Laptop 4</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">Logitech MX 250</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">AudioEngine HD3</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">HP Hyper LTR</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                    ...
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">Dell 32 UltraSharp</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
                                        <td class="text-end">#XGY-356</td>
                                    ...
                                    <tr>
                                        <!--begin::Item-->
                                        <td>
                                            <a href="{{asset('backend/apps/ecommerce/catalog/edit-product.html')}}" class="text-dark text-hover-primary">Google Pixel 6 Pro</a>
                                        </td>
                                        <!--end::Item-->
                                        <!--begin::Product ID-->
