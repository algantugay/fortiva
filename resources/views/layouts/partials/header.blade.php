    ...
    <div class="toolbar d-flex align-items-stretch">
        ...
        <div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
            ...
            <div class="page-title d-flex justify-content-center flex-column me-5">
                <!--begin::Title-->
                <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">eCommerce Dashboard</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">
                        <a href="{{asset('backend/index.html')}}" class="text-muted text-hover-primary">Home</a>
                    </li>
                    <!--end::Item-->
                    <!--begin::Item-->
            ...
            <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Menu- wrapper-->
                            <a href="{{asset('backend/apps/subscriptions/add.html')}}" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
                        ...
                        <div class="d-flex align-items-center">
                            <!--begin::Menu wrapper-->
                            <a href="{{asset('backend/apps/file-manager/folders.html')}}" class="btn btn-sm btn-icon btn-icon-muted btn-active-icon-primary">
