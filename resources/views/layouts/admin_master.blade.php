								...
								<div class="timeline-content mb-10 mt-n1">
									...
									<div class="overflow-auto pb-5">
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
											<!--begin::Title-->
											<a href="{{asset('backend/apps/projects/project.html')}}" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Meeting with customer</a>
											<!--end::Title-->
											<!--begin::Label-->
											...
											<!--end::Progress-->
											<!--begin::Action-->
											<a href="{{asset('backend/apps/projects/project.html')}}" class="btn btn-sm btn-light btn-active-light-primary">View</a>
											<!--end::Action-->
										</div>
										<!--end::Record-->
										<!--begin::Record-->
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-0">
											<!--begin::Title-->
											<a href="{{asset('backend/apps/projects/project.html')}}" class="fs-5 text-dark text-hover-primary fw-semibold w-375px min-w-200px">Project Delivery Preparation</a>
											<!--end::Title-->
											<!--begin::Label-->
										...
										<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5">
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												...
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
													<a href="{{asset('backend/apps/projects/project.html')}}" class="fs-6 text-hover-primary fw-bold">Finance KPI App Guidelines</a>
													<!--end::Desc-->
													<!--begin::Number-->
											...
											<div class="d-flex flex-aligns-center pe-10 pe-lg-20">
												<!--begin::Icon-->
												<img alt="../../demo8/dist/apps/projects/project.html" class="w-30px me-3" src="{{asset('backend/assets/media/svg/files/doc.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
											...
											<div class="d-flex flex-aligns-center">
												<!--begin::Icon-->
												<img alt="../../demo8/dist/apps/projects/project.html" class="w-30px me-3" src="{{asset('backend/assets/media/svg/files/css.svg')}}" />
												<!--end::Icon-->
												<!--begin::Info-->
												<div class="ms-1 fw-semibold">
													<!--begin::Desc-->
				...
				<div class="card-body hover-scroll-overlay-y h-400px pt-5">
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fs-4 fw-bold">Iblender</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fs-4 fw-bold">SmartCleaner</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fs-4 fw-bold">CameraMaxr</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fs-4 fw-bold">$D Printer</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fs-4 fw-bold">MotionWire</a>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex flex-column me-3">
							<!--begin::Section-->
							<div class="mb-3">
								<a href="{{asset('backend/apps/ecommerce/sales/details.html')}}" class="text-gray-800 text-hover-primary fs-4 fw-bold">Samsung</a>
