			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="{{ route('login') }}" data-kt-redirect-url="/dashboard">
                            @csrf
                            <!--begin::Heading-->
                            ...
                            <div class="fv-row mb-8">
                                <input class="form-control bg-transparent" type="email" name="email" id="email" autocomplete="off" required="" placeholder="Email"/>
                            </div>
                            <!--end::Input group-->
                            <div class="fv-row mb-3">
                                <input class="form-control bg-transparent" type="password"  name="password" id="password" autocomplete="off" required="" placeholder="Password"/>
                            </div>
                            <!--end::Input group-->
					...
					<div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
						...
						<div class="d-flex fw-semibold text-primary fs-base gap-5">
							<a href="{{asset('backend/pages/team.html')}}" target="_blank">Terms</a>
							<a href="{{asset('backend/pages/pricing/column.html')}}" target="_blank">Plans</a>
							<a href="{{asset('backend/pages/contact.html')}}" target="_blank">Contact Us</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url({{asset('backend/assets/media/misc/auth-bg.png')}})">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						<!--begin::Logo-->
						<a href="{{asset('backend/index.html')}}" class="mb-0 mb-lg-12">
